...
import com.zuqiuyu.handsetmonitor.UIActions.BTDevicesAdapter;
import com.zuqiuyu.handsetmonitor.bluetooth.BluetoothChatService;
import com.zuqiuyu.handsetmonitor.bluetooth.BluetoothUtils;
import com.zuqiuyu.handsetmonitor.utils.CONST;
import com.zuqiuyu.handsetmonitor.utils.utils;
import com.zuqiuyu.handsetmonitor.wave.Wave;
import com.zuqiuyu.handsetmonitor.wave.WaveParse;
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) 
			{
				...
				case CONST.MESSAGE_ECG_PARAMS:
					UIActions.RefreshResp(msg.arg1);//呼吸频率
					UIActions.RefreshHR(msg.arg2);//心率
					break;
				//血氧参数
			    ...
			    case CONST.MESSAGE_TEMP_PARAMS:
			    	UIActions.RefreshTemp(msg.arg1,msg.arg2);//温度
			    	break;
				//无损血压参数
				...
				case CONST.MESSAGE_BLUETOOTH_STATE_CHANGE:
					{
						switch(msg.arg1)
						{
							case BluetoothChatService.STATE_CONNECTING:
								mBtConnectProgressDialog = ProgressDialog.show(MainActivity.this, null, getResources().getString(com.zuqiuyu.handsetmonitor.R.string.wait_for_connect));
								UIActions.ShowMainScreen();
								break;
				...
				case CONST.MESSAGE_BLUETOOTH_DEVICE_NAME:
					...
					Toast.makeText(MainActivity.this, getResources().getString(com.zuqiuyu.handsetmonitor.R.string.connect_successfully)+" "+strName, Toast.LENGTH_SHORT).show();
					break;
				//蓝牙连接失败
